...
final class MovieHeaderView: UIView {
    ...
    fileprivate func setupBackButton() {
        ...
        backButton.topAnchor.constraint(equalTo: containerView.topAnchor, constant: 28).isActive = true
...
final class SmallMovieHeaderView: UIView {
...
//    }
    ...
    fileprivate func setupTitleLabel() {
        ...
        titleLabel.centerYAnchor.constraint(equalTo: containerView.centerYAnchor, constant: 6).isActive = true
    }
